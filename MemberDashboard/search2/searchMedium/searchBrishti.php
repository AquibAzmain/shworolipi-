...
$query = "SELECT * FROM song,mood WHERE mood_name = 'বৃষ্টি' AND song.song_id = mood.song_id ";
...
<table align="center" id="myTable" style="width:82%">
  <tr class="header">
    ...
    <th style="width:40%;">
      <form action = "../musicPlayer/audioMood.php" method="POST">
        <input type="hidden" name = "mood"  value = "বৃষ্টি" >
