...
<div class="w3-top" style="z-index:3;">
 <div class="w3-bar w3-black w3-theme-d2 w3-left-align w3-large">
  ...
  <a style = "text-decoration: none;" href="logout.php" class="w3-bar-item w3-button w3-hide-small w3-right"><i class="fa fa-sign-out"></i> লগ আউট</a>
 </div>
</div>


<div class="tab" style = "padding-top: 1cm; height: 800px">
  <button class="tablinks" onclick="openCity(event, 'হোম')" id="defaultOpen">
    <div class="chip">
  ...
  <button class="tablinks"onclick="openCity(event, 'নির্দেশনা')">নির্দেশনা</button>
</div>

<div style = "padding-top: 2cm;" id="হোম" class="tabcontent">
   <!--<img src="images/cartoon.gif" alt=":P" width="50%" height="80%" style = "display: block;  margin: 0 auto;">-->
</div>
